...
constexpr double ALLOTMENT_FACTORS[10] = {1.0, 0.99, 0.40, 0.30, 0.25, 0.21, 0.18, 0.16, 0.14, 0.13};
constexpr double MAX_USAGE_FACTORS[10] = {1.0, 0.99, 0.80, 0.70, 0.64, 0.60, 0.57, 0.54, 0.52, 0.51};
