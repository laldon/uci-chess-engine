...
constexpr uint64_t KING_ZONE_FLANK[8] = {
    FILE_A | FILE_B | FILE_C, QSIDE, QSIDE, CENTER_FILES, CENTER_FILES, KSIDE, KSIDE, FILE_F | FILE_G | FILE_H
};
constexpr uint64_t KING_DEFENSE_ZONE[8] = {
    QSIDE ^ FILE_D, QSIDE ^ FILE_D, QSIDE, FILE_D | FILE_E,
    FILE_D | FILE_E, KSIDE, KSIDE ^ FILE_E, KSIDE ^ FILE_E
};
