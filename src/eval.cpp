...
constexpr uint64_t KING_ZONE_DEFENDER[2] = {HALF[WHITE] | RANK_5 | RANK_6, RANK_3 | RANK_4 | HALF[BLACK]};
...
constexpr uint64_t KING_DEFENSE_ZONE[8] = {
    QSIDE ^ FILE_D, QSIDE ^ FILE_D, QSIDE ^ FILE_A, FILE_C | FILE_D | FILE_E,
    FILE_D | FILE_E | FILE_F, KSIDE ^ FILE_H, KSIDE ^ FILE_E, KSIDE ^ FILE_E
};
